...
# either sitting at the machine, or remotely via ssh: .bash_profile
# is executed to configure your shell before the initial command
# prompt. But, if you’ve already logged into your machine and
# open a new terminal window (xterm) inside Gnome or KDE, then
# .bashrc is executed before the window command prompt. .bashrc
# is also run when you start a new bash instance by typing
